...
const LandingFooter = () => {
  return (
    <main className="min-h-[100px] bg-gray-50 border-t text-center md:text-start ">
      <section className="w-full md:w-[800px] lg:w-[1200px] container mx-auto p-4 ">
        <div className="block md:flex justify-between items-end w-full">
          <section className="block md:flex items-end">
            <h1 className="text-2xl font-bold m-0 md:mr-6 mb-2">Zai</h1>
            <p className="text-xs text-gray-600 pb-[6px]">
              © 2023 My Company. All rights reserved.
            </p>
          </section>
          <section className="flex text-2xl  justify-center md:justify-start mt-3">

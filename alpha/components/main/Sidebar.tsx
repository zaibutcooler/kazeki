  ...
  return (
    <div>
      <div className="fixed inset-0 z-10 backdrop-filter backdrop-blur">
        <div
          className="w-2/3 md:w-2/5 lg:w-1/5 bg-superwhite h-screen p-4 border-r overflow-y-auto scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100"
          onClick={() => {}}>

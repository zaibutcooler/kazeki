...
//     useState<FreelanceOfferFormState>(initialFormData);
...
//     setFormData((prevFormData) => {
//       const newResponsibilities = [...prevFormData.responsibilities];
...
//   ) => {
//     setFormData((prevFormData) => {
//       const newContact = [...prevFormData.contact];
...
//     setFormData((prevFormData) => ({
//       ...prevFormData,
//       contact: [...prevFormData.contact, { label: "", link: "" }],
//     }));
//   };
...
//               {/* Replace the icon component with the actual icon you want to use */}
//               <UserCircleIcon
